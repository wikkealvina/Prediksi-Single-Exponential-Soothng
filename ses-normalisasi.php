                                ...
                                <div class="card-body">
                                    ...
                                    function normalisasiData($data)
                                    {
                                        ...
                                        foreach ($data as $key => $value) {
                                            $data[$key] = ((0.8 * ($value - $minValue)) / ($maxValue - $minValue)) + 0.1;
                                        }
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        //Proses Grid Search
                                        for ($alpha = $minAlpha; $alpha <= $maxAlpha; $alpha += $increment) {
                                            ...
                                            $historicalData = normalisasiData($historicalData);
                                            ...
                                            for ($i = 0; $i < count($hasilPrediksi); $i++) {
                                                if ($i < count($historicalData)) {
                                                    $totalError += (abs($historicalData[$i] - $hasilPrediksi[$i]) / $historicalData[$i]);
                                                    $count++;
                                                }
                                            }
                                            $mape = $count > 0 ? ($totalError / $count) * 100 : 0;
                                    ...
                                    ?>
                                        ...
                                        <h4 class="card-title mt-5">Tabel Hasil Prediksi SES (Data Normalisasi)</h4>
                                            ...
                                            <table class="table table-bordered" style="text-align:center" id="myTable1">
                                                ...
                                                <tbody>
                                                    ...
                                                    for ($i = 0; $i < $totalMonths; $i++) {
                                                        ...
                                                        $aktual = isset($historicalData[$i]) ? number_format($historicalData[$i], 4) : "-";
                                                        $prediksi = number_format($hasilPrediksi[$i], 4);
                                                        $pe = "-";
                                        ...
                                        <div class="alert alert-success">
                                            <p class="mb-0">
                                                <?php
                                                echo "MAPE terbaik: " . number_format($bestMape, 5) . "%";
                                                ?>
                                            </p>
                                        </div>
                                        <!-- Line Chart -->
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                        ...
                                                        for ($alpha = $minAlpha; $alpha < $maxAlpha + $increment; $alpha += $increment) {
                                                            ...
                                                            echo '<tr>';
                                                            echo '<td>' . ($no++) . '</td>';
                                                            echo '<td>' . number_format($alpha, 3) . '</td>'; // Menampilkan nilai alpha dengan tiga desimal
                                                            echo '<td>' . ($mape !== "N/A" ? number_format($mape, 5) . "%" : $mape) . '</td>'; // Menampilkan MAPE dengan tiga desimal jika tidak N/A
                                                            echo '</tr>';
                                                        }
                                                    }
                                                    ?>
